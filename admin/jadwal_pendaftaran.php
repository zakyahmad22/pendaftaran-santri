...
<body>
            ...
            <div class="container mx-auto px-4 max-w-3xl lg:max-w-5xl">
                <div class="breadcrumbs text-secondary dark:text-white pb-3">
                    <ol class="flex space-x-2 text-sm px-4 pb-5">
                        ...
                        <li class="current text-primary">Jadwal Pendaftaran</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container max-w-6xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php while ($row = $result->fetch_assoc()): ?>
                    <div class="jadwal-card opacity-0 translate-y-10 transition-all duration-700 
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            // Animasikan judul
            document.getElementById('judulJadwal').classList.remove('opacity-0', 'translate-y-10');
