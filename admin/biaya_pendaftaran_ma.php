...
// Ambil data dari tabel biaya_pendaftaran_ma
$query = "SELECT * FROM biaya_pendaftaran_ma ORDER BY jenis_kelamin, id";
...
<head>
    ...
    <title>Biaya Pendaftaran MA</title>
            ...
            <div class="container mx-auto px-4 max-w-3xl lg:max-w-5xl">
                <div class="breadcrumbs text-secondary dark:text-white pb-3">
                    <ol class="flex space-x-2 text-sm px-4 pb-5">
                        ...
                        <li class="current text-primary">Biaya Pendaftaran MA</li>
                    </ol>
                </div>
            </div>
        </div>
