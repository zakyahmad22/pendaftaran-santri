...
<body class="bg-gray-100 p-6">
    <div class="max-w-5xl mx-auto bg-white p-6 rounded shadow">
        <h1 class="text-2xl font-bold mb-6">Kelola Alumni</h1>

        <!-- Form Edit Judul Alumni -->
        <div class="mb-10">
        ...
        <form action="" method="post" enctype="multipart/form-data" class="mb-10">
            ...
            <button type="submit" name="simpan" class="mt-4 bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded">
                <?= $edit ? 'Update' : 'Tambah' ?>
            </button>
        </form>
