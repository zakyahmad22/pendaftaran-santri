    ...
    <div class="flex flex-wrap">
      ...
      <div class="w-full self-end px-4 lg:w-1/2">
        <div class="relative mt-10 lg:right-0 lg:mt-9">
          <img src="dist/img/santri2.png" alt="santri2" width="400" height="400"
...
<div class="bg-gray-100 py-12 fade-up">
  <div class="container mx-auto text-center fade-up">
    <h1 class="text-4xl font-bold font-sans fade-up">Falsafah Pondok</h1>
    <p class="mt-4 fade-up">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
      <!-- Kolom 1: Panca Jiwa -->
      <div class="bg-white p-6 rounded-lg shadow-md fade-up">
  ...
  <div class="container">
    <div class="w-full px-4">
      <div class="mx-auto mb-16 max-w-xl text-center">
        ...
        <h2 class="mb-4 text-3xl font-bold text-dark dark:text-white sm:text-4xl lg:text-5xl"><span
            class="mb-4 text-3xl font-bold sm:text-4xl lg:text-5xl text-primary">Pusat</span> Informasi</h2>
        <p class="text-md font-medium text-secondary md:text-lg">
          ...
          pendaftaran santri
          baru, program pendidikan, jadwal kegiatan, dan fasilitas pondok.
        </p>
      </div>
    </div>
    ...
    <div class="flex w-full flex-wrap justify-center px-4 xl:mx-auto xl:w-10/12">
      <div class="mb-12 p-4 md:w-1/2">
        <div class="overflow-hidden rounded-md shadow-md">
          <img src="dist/img/informasi1.jpg" alt="Landing Page" width="w-full" />
        </div>
        <h3 class="mt-5 mb-5 text-xl font-semibold text-dark dark:text-white">Pendaftaran dan Ujian</h3>
        <p class="text-base font-medium text-secondary">Pondok Pesantren Al-Muflihin membuka pendaftaran santri baru
          setiap tahun untuk memberikan kesempatan bagi generasi muda
          yang ingin menimba ilmu agama dan umum.</p>
      </div>
      <div class="mb-12 p-4 md:w-1/2">
        <div class="overflow-hidden rounded-md shadow-md">
          <img src="dist/img/informasi2.JPG" alt="E-Commerce" width="w-full" />
        </div>
        <h3 class="mt-5 mb-3 text-xl font-semibold text-dark dark:text-white">Haul Almagfurllah</h3>
        <p class="text-base font-medium text-secondary">Haul Almaghfurlah adalah acara tahunan yang diselenggarakan
          oleh Pondok Pesantren Al-Muflihin untuk mengenang dan
          mendoakan pendiri serta tokoh-tokoh yang berjasa dalam perjuangan dan pengembangan pondok pesantren.</p>
      </div>
      <div class="mb-12 p-4 md:w-1/2">
        <div class="overflow-hidden rounded-md shadow-md">
          <img src="dist/img/informasi3.jpg" alt="Technical Documentation" width="w-full" />
        </div>
        <h3 class="mt-5 mb-3 text-xl font-semibold text-dark dark:text-white">Praktek Khitobah</h3>
        <p class="text-base font-medium text-secondary">Praktek Khitobah adalah salah satu kegiatan unggulan di Pondok
          Pesantren Al-Muflihin yang bertujuan untuk melatih santri
          dalam kemampuan berbicara di depan umum, khususnya dalam menyampaikan dakwah atau pidato islami.</p>
      </div>
      <div class="mb-12 p-4 md:w-1/2">
        <div class="overflow-hidden rounded-md shadow-md">
          <img src="dist/img/informasi4.jpg" alt="Tribute Page" width="w-full" />
        </div>
        <h3 class="mt-5 mb-3 text-xl font-semibold text-dark dark:text-white">Ujian Seleksi Pendaftaran Santri Baru
        </h3>
        <p class="text-base font-medium text-secondary">Pondok Pesantren Al-Muflihin menyelenggarakan ujian seleksi
          untuk memastikan calon santri memenuhi syarat dan memiliki
          kesiapan untuk mengikuti pendidikan di pondok.</p>
      </div>
    </div>
  </div>
</section>
