...
<body class="pt-9 dark:bg-dark">
    <section id="pendaftaran" class="pt-36 pb-32">
        ...
        <!-- End Page Title -->
        <div class="container mx-auto px-4 bg-white rounded-lg shadow-lg dark:bg-dark dark:shadow-slate-500">
            <div class="w-full">
            ...
            <form action="/pendaftaran-santri/proses/proses_pendaftaran.php" method="POST" class="w-full lg:mx-auto lg:w-2/3">
                <!-- Tanggal Pendaftaran -->
